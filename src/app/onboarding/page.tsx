  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '540px' }}>
        ...
        {step > 1 && (
          <button onClick={back} style={{ width: '100%', padding: '14px', background: 'none', border: 'none', color: '#333', fontSize: '14px', cursor: 'pointer', marginTop: '10px', fontFamily: 'DM Sans, sans-serif' }}>
            ← Back
          </button>
        )}
      </div>
